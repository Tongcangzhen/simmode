...
//        List<WorkData> workData = objectMapper.readValue(result, new TypeReference<List<WorkData>>() {});
//        System.out.printf(workData.toString());
    ...
    public List<WorkData> getWorkdatas(Set<Integer> set) {
       ...
       // System.out.println("\n" + result);
        ...
        try {
            list = objectMapper.readValue(result, new TypeReference<List<WorkData>>() {});
        } catch (IOException e) {
            e.printStackTrace();
        }
        //System.out.printf(workData.toString());
